...
class TermsConditionVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    var arrTitle = [
        ...
        "AI Data Sent For Processing",
        "AI Storage, Retention, And Deletion",
        "Payments",
        "Data Storage",
        "Data Sharing",
        "Your Choices",
    ...
    var arrDesc = [
        ...
        "SpeedListener uses AI for bookmark transcription and summary features. This processing is cloud-based and may use trusted AI service providers.",
        "When you request transcription/summary, SpeedListener may send:\n• Short bookmarked audio clips\n• Related transcription text for summarization\n\nSpeedListener does not need to upload your full library for this feature.",
        "AI outputs (transcription and summary) are stored locally on your device for usability. You can remove related data by deleting associated bookmarks/books in SpeedListener. Account deletion requests are also supported through app support flows.",
